          ...
          <div class="col-md-12">
            ...
            <div class="collapse navbar-collapse navbar-right" id="myNavbar">
              <ul class="nav navbar-nav">
                ...
                <li class=""><a href="/Doctello-master/faq.php">FAQ</a></li>
    ...
    <div class="container">
      <div class=" row">
        ...
        <div class="col-md-4 col-sm-5">
          ...
          <p class="text-right text-primary"><i>— Ishan Jain<br>B.tech CSE</i></p>
        </div>
        <div class="col-md-2"></div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-4 col-sm-4">
          <h3>Contact Info</h3>
          <div class="space"></div>
          <p><i class="fa fa-map-marker fa-fw pull-left fa-2x"></i>Jaipur,Rajasthan<br> India, 302033</p>
          <div class="space"></div>
          <p><i class="fa fa-envelope-o fa-fw pull-left fa-2x"></i>ishanjain7240@gmail.com</p>
          <div class="space"></div>
          <p><i class="fa fa-phone fa-fw pull-left fa-2x"></i>+91 7240 2031 87</p>
        </div>
